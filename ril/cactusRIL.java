...
public class cactusRIL extends RIL implements CommandsInterface {
...
static int registered = 0;
    ...
    public cactusRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public cactusRIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
